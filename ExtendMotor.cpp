...
ExtendMotor::ExtendMotor()
    : Motor(), _rise_level(default_change_level),
      _fall_level(default_change_level), _ttl(default_ttl),
...
ChangeLevel ExtendMotor::rise_level() const { return _rise_level; }
...
ChangeLevel ExtendMotor::fall_level() const { return _fall_level; }
...
float ExtendMotor::rise_unit() const { return _rise_unit; }
...
float ExtendMotor::fall_unit() const { return _fall_unit; }

void ExtendMotor::ttl(unsigned int millisec) { _ttl = millisec; }

unsigned int ExtendMotor::ttl() const { return _ttl; }
...
Decay ExtendMotor::decay() const { return _decay; }
